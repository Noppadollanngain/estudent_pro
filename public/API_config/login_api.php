<?php
    ...
    if( $result_1[0] == 0){
        ...
        if( $result_2[0]==0){
            ...
            $data_show = "select * from documents left join students on documents.student = students.id where  students.stdId = '".$data['username']."' and students.peopleId = '".$data['password']."'";
