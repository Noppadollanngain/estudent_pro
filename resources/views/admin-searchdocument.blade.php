      ...
      <div class="col-md-12 d-flex align-items-stretch">
        <div class="row flex-grow">
          <div class="col-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title" style="font-size:1.25rem;font-family: 'Athiti', sans-serif;">ค้นหารายการส่งเอกสาร</h4>
                ...
                <div class="form-group">
                  <label style="font-size:1rem;font-family: 'Athiti', sans-serif;">ค้นหาจากเลขที่สัญญา</label>
                  {!! Form::open(array('route'=>'document-searchBy','method' => 'get')) !!}
                      <div class="input-group">
